#' Outline of the Mississippi Sound Watershed HUC4s
#'
#' The Mississippi Sound Watershed is made up of HUC4s 0317 (Pascagoula River basin) and 0318 (Pearl River basin). This object contains the outlines of both basins.
#'
#' @format A Simple feature collection with 2 features and 2 fields.
#' \describe{
#'   \item{`huc4`}{character, HUC4 ID.}
#'   \item{`name`}{character, name of the HUC4 unit.}
#'   \item{`geometry`}{POLYGON of the MSEP watershed HUC4s.}
#' }
