#' Subbasins (HUC8s) of the MS-only portion of the Mississippi Sound Watershed
#'
#' The Mississippi Sound Watershed is made up of HUC4s 0317 (Pascagoula River basin) and 0318 (Pearl River basin). This is the combination of all HUC8 units within them, clipped to MS state boundaries (as MSEP's current funding only allows work within the state).
#'
