...
union, clipped to MS state boundaries (as MSEP's current funding only
allows work within the state).
...
- `geometry`:
  ...
  POLYGON of the MSEP watershed outline, clipped to MS boundaries.
